...
<div class="col-12">
    <div class="card">
        <div class="card-body"> 
            <form method="post" action="{{ route('update.testimonial',$testiSlide->id) }}" enctype="multipart/form-data" id="testimonialform">
                @csrf
              <input type="hidden" name="id" value="{{ $testiSlide->id }}" id="id"/>
            <div class="row mb-3">
